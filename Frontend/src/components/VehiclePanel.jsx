  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex border-2 border-[#2196F3] hover:border-[#1976D2] mb-2 rounded-xl w-full p-3 items-center justify-between transition-all"
      >
        <img
          className="h-10"
        ...
        <h2 className="text-lg font-semibold text-[#2196F3]">
          ₹{props.fare.car}
        </h2>
      </div>
